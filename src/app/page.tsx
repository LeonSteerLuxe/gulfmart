      ...
      <section id="features" className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-3 gap-4">
            ...
            {/* Stats card */}
            <div className="bg-gradient-to-br from-emerald-500 to-cyan-500 text-white rounded-3xl p-10 flex flex-col justify-between shadow-xl">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="relative">
                <div className={`text-7xl font-black bg-gradient-to-br ${step.color} bg-clip-text text-transparent opacity-40 mb-4`}>
                  {step.num}
                </div>
