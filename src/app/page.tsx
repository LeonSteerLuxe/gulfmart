...
import { Sparkles, ArrowRight, Truck, Shield, Package, Check, ArrowUpRight } from "lucide-react";

const categories = [
  { name: "Electronics", items: "3,200+", image: "https://images.unsplash.com/photo-1498049794561-7780e7231661?w=400&h=300&fit=crop" },
  { name: "Tools & Hardware", items: "2,500+", image: "https://images.unsplash.com/photo-1581783898377-1c85bf937427?w=400&h=300&fit=crop" },
  { name: "Auto Parts", items: "1,800+", image: "https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?w=400&h=300&fit=crop" },
  ...
  { name: "Sports & Fitness", items: "800+", image: "https://images.unsplash.com/photo-1517649763962-0c623066013b?w=400&h=300&fit=crop" },
  { name: "Health & Safety", items: "600+", image: "https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?w=400&h=300&fit=crop" },
];

const steps = [
  { num: "01", title: "Browse", desc: "Explore 10,000+ products across categories", gradient: "from-violet-500 to-purple-500" },
  { num: "02", title: "Order", desc: "Pay by card, transfer, or cash on delivery", gradient: "from-blue-500 to-cyan-500" },
  { num: "03", title: "We ship", desc: "Consolidation & customs fully handled", gradient: "from-emerald-500 to-green-500" },
  { num: "04", title: "Receive", desc: "Delivered to your door across Oman", gradient: "from-orange-500 to-amber-500" },
];
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-xl border-b border-zinc-100">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Link href="/login" className="text-sm text-zinc-600 hover:text-zinc-900 transition-colors">Sign in</Link>
            <Link href="/signup" className="text-sm font-medium bg-zinc-900 text-white px-4 py-2 rounded-full hover:bg-zinc-800 transition-colors">Get started</Link>
          </div>
        </div>
      </header>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="max-w-4xl">
            ...
            <h1 className="text-6xl md:text-7xl lg:text-8xl font-bold tracking-tight leading-[0.95] mb-8">
              Shop UAE.<br />
              <span className="bg-gradient-to-r from-emerald-500 via-cyan-500 to-blue-500 bg-clip-text text-transparent">Delivered to Oman.</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-start gap-4">
              <Link href="/signup" className="group inline-flex items-center gap-2 bg-zinc-900 text-white text-base font-medium px-6 py-3.5 rounded-full hover:bg-zinc-800 transition-all hover:gap-3">
                Start shopping
                <ArrowRight className="w-4 h-4" />
              </Link>
              <Link href="#how" className="inline-flex items-center gap-2 text-zinc-600 hover:text-zinc-900 text-base font-medium px-6 py-3.5 transition-colors">
                See how it works
              </Link>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            <div className="md:col-span-2 bg-gradient-to-br from-zinc-50 to-zinc-100/50 rounded-3xl p-10 border border-zinc-200/50">
              <div className="flex items-start justify-between mb-16">
                ...
                <span className="text-sm font-medium text-emerald-600 bg-emerald-50 px-3 py-1 rounded-full">2-4 days</span>
              </div>
              <h3 className="text-3xl font-bold mb-3">Lightning fast delivery</h3>
              <p className="text-lg text-zinc-500 max-w-md">From Dubai warehouses to your doorstep in Oman. Faster than you&apos;d expect.</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-emerald-500 to-cyan-500 text-white rounded-3xl p-10">
              ...
              <p className="text-white/80">Full refund if items aren&apos;t as described. No questions asked.</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-zinc-50 to-zinc-100/50 rounded-3xl p-10 border border-zinc-200/50">
              ...
              <p className="text-zinc-500">Multiple suppliers, one shipment. Save up to 40% on shipping.</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-3xl p-10 border border-amber-200/50">
              ...
              <p className="text-zinc-500">We manage all paperwork and clearance. Zero hassle for you.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="how" className="py-24 px-6 bg-zinc-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold tracking-tight mb-4">Simple as 1, 2, 3, 4</h2>
            <p className="text-xl text-zinc-500">No complexity. Just results.</p>
          </div>
          <div className="grid md:grid-cols-4 gap-8">
            {steps.map((step) => (
              <div key={step.num} className="relative">
                <div className={`text-7xl font-black bg-gradient-to-br ${step.gradient} bg-clip-text text-transparent opacity-20 mb-4`}>
                  {step.num}
                </div>
      ...
      <section id="categories" className="py-24 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-end justify-between mb-12">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold tracking-tight mb-4">What you can buy</h2>
              <p className="text-xl text-zinc-500">Everything you need, from UAE to Oman</p>
            </div>
            <Link href="/categories" className="hidden md:inline-flex items-center gap-1 text-zinc-500 hover:text-zinc-900 font-medium transition-colors">
              View all
            ...
            {categories.map((cat) => (
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <div className="text-zinc-400 text-sm">{cat.items} items</div>
                </div>
              </Link>
            ))}
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="relative overflow-hidden bg-zinc-900 rounded-[2.5rem] p-12 md:p-20">
            ...
            <div className="relative">
              <h2 className="text-4xl md:text-6xl font-bold text-white tracking-tight mb-6">Ready to start?</h2>
              <p className="text-xl text-zinc-400 max-w-xl mb-10">Join thousands of happy customers across Oman. No fees, no minimum orders, no hassle.</p>
              <div className="flex flex-col sm:flex-row gap-4 mb-10">
                <Link href="/signup" className="inline-flex items-center justify-center gap-2 bg-white text-zinc-900 font-semibold px-8 py-4 rounded-full hover:bg-zinc-100 transition-colors">
                  Create free account
                  <ArrowRight className="w-4 h-4" />
                </Link>
                <Link href="/contact" className="inline-flex items-center justify-center gap-2 text-white font-semibold px-8 py-4 rounded-full border border-zinc-700 hover:bg-zinc-800 transition-colors">
                  Talk to sales
                </Link>
              </div>
              <div className="flex flex-wrap gap-6 text-zinc-400 text-sm">
                <span className="flex items-center gap-2"><Check className="w-5 h-5 text-emerald-400" />No membership fees</span>
                <span className="flex items-center gap-2"><Check className="w-5 h-5 text-emerald-400" />Cash on delivery</span>
                <span className="flex items-center gap-2"><Check className="w-5 h-5 text-emerald-400" />7-day free returns</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <footer className="border-t border-zinc-100 py-12 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
            ...
            <div className="text-sm text-zinc-400">© 2025 GulfMart</div>
          </div>
        </div>
      </footer>
    </div>
