    ...
    <div className="min-h-screen bg-white text-zinc-900">
      ...
      <main className="pt-32 pb-20 px-6">
        <div className="max-w-md mx-auto">
          ...
          {/* Benefits */}
          <div className="bg-gray-50/50 border border-gray-200 rounded-xl p-4 mb-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-gray-50 border border-gray-200 rounded-xl py-3.5 pl-12 pr-4 focus:outline-none focus:border-emerald-500 transition-colors"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-gray-50 border border-gray-200 rounded-xl py-3.5 pl-12 pr-12 focus:outline-none focus:border-emerald-500 transition-colors"
                  placeholder="••••••••"
                />
                <button
                  type="button"
            ...
            <div className="flex items-start gap-3">
              <input
                type="checkbox"
                required
                className="w-4 h-4 mt-0.5 rounded border-zinc-700 bg-gray-50 text-emerald-500 focus:ring-emerald-500"
              />
              <span className="text-sm text-zinc-600">
                I agree to the{' '}
                <Link href="/terms" className="text-emerald-600 hover:text-emerald-300">Terms of Service</Link>
                {' '}and{' '}
                <Link href="/privacy" className="text-emerald-600 hover:text-emerald-300">Privacy Policy</Link>
              </span>
            </div>
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            <button className="flex items-center justify-center gap-2 bg-gray-50 border border-gray-200 hover:border-gray-300 py-3 rounded-xl transition-colors">
          ...
          <p className="text-center text-zinc-600">
            ...
            <Link href="/login" className="text-emerald-600 hover:text-emerald-300 font-medium">
              Sign in
            </Link>
          </p>
        </div>
